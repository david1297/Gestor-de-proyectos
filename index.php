...
<body>
			...
			<div class="container-fluid">
				...
				<div class="dashboard-section">
					<div class="section-heading clearfix">
						<h2 class="section-title"><i class="fas fa-chart-pie"></i>Analisis de Proyectos</h2>
	...
	$(function() {
		...
		toastr['info']('Hola, bienvenidos a Gestor de Proyectos, un panel de administración único.');
